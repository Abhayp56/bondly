...
import { Lock, Sparkles, CheckCircle2, Flame, Award, Heart, RefreshCw, HelpCircle, ArrowRight, ShieldCheck } from 'lucide-react';
import { Profile, DailySession, DailyQuestion } from '../types';
...
export default function AnswerCheckerView({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Header Banner */}
      <div className="bg-white border border-vborder rounded-3xl p-5 shadow-sm space-y-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h2 className="text-lg font-extrabold text-vcharcoal font-display leading-tight">
                Daily Answer Checker
              </h2>
              <p className="text-[11px] text-vgray font-medium">
                Reveals all responses once all 5 questions are complete
              </p>
            </div>
          </div>
      ...
      {/* LOCKED STATE CARD (When less than 5 questions completed) */}
      {!isAllComplete ? (
        <div className="bg-white border border-vborder rounded-[32px] p-6 text-center space-y-5 shadow-sm">
          ...
          <div className="space-y-2 max-w-xs mx-auto">
            <h3 className="text-base font-extrabold text-vcharcoal font-display">
              Answer Checker Locked
            </h3>
            <p className="text-xs text-vgray leading-relaxed font-medium">
              To keep the surprise exciting, responses and AI match scores remain sealed until <span className="font-bold text-vcharcoal">both you and {profile.partnerName}</span> answer all 5 daily questions!
            </p>
          </div>
        ...
        /* UNLOCKED FULL ANSWER CHECKER VIEW */
        <div className="space-y-5">
